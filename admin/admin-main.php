...
<div class="scw-admin-wrap">
    ...
    <div class="scw-header">
        <ul class="scw-tabs">
            <li>
                <a href="#"
                   class="scw-tab <?php echo $current_step === 0 ? 'active' : ''; ?>"
                   data-step="0">
                    <span><?php esc_html_e( '1. Select Channels', 'social-chat-widget' ); ?></span>
                </a>
            </li>
            <li>
                <a href="#"
                   class="scw-tab <?php echo $current_step === 1 ? 'active' : ''; ?>"
                   data-step="1">
                    <span><?php esc_html_e( '2. Widget Customization', 'social-chat-widget' ); ?></span>
                </a>
            </li>
            <li>
                <a href="#"
                   class="scw-tab <?php echo $current_step === 2 ? 'active' : ''; ?>"
                   data-step="2">
                    <span><?php esc_html_e( '3. Triggers & Targeting', 'social-chat-widget' ); ?></span>
                </a>
            </li>
            <li>
                <a href="#"
                   class="scw-tab <?php echo $current_step === 3 ? 'active' : ''; ?>"
                   data-step="3">
                    <span><?php esc_html_e( '4. Settings', 'social-chat-widget' ); ?></span>
                </a>
            </li>
        </ul>
    </div>
    ...
    <div class="scw-content">
        ...
        <div class="scw-preview-panel">
            <div class="scw-preview">
                <h3 class="scw-preview-title">
                    <?php esc_html_e( 'Preview', 'social-chat-widget' ); ?>
                </h3>

                <div class="scw-preview-device">
                    <p style="text-align:center; color:#9ca3af; padding:20px;">
                        <?php esc_html_e( 'Widget preview will appear here', 'social-chat-widget' ); ?>
                    </p>
    ...
    <div class="scw-navigation">
        ...
        <button type="button"
                id="scw-back-btn"
                class="scw-btn scw-btn-secondary"
                disabled>
            ...
            <?php esc_html_e( 'Back', 'social-chat-widget' ); ?>
        </button>
        ...
        <div style="display:flex; gap:10px;">
            ...
            <button type="button"
                    id="scw-next-btn"
                    class="scw-btn scw-btn-secondary">
                <?php esc_html_e( 'Next', 'social-chat-widget' ); ?>
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                     xmlns="http://www.w3.org/2000/svg">
            ...
            <button type="button"
                ...
                <?php esc_html_e( 'Save Settings', 'social-chat-widget' ); ?>
            </button>
