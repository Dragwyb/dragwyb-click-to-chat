...
<div class="dctc-form-group" id="dctc-show-widget-setting">
	<label><?php esc_html_e( 'Widget Display', 'dragwyb-click-to-chat' ); ?></label>
	<p style="color: #9ca3af; font-size: 13px; margin-bottom: 15px;">
		<?php esc_html_e( 'Control how your channel widgets appear on your website. Use a single floating button to expand channels, or display channel buttons directly.', 'dragwyb-click-to-chat' ); ?>
	</p>
	<label class="dctc-toggle">
		...
		<span style="margin-left: 10px; font-weight: 500; color: #374151;"><?php esc_html_e( 'Show Floating Button', 'dragwyb-click-to-chat' ); ?></span>
	</label>
