...
/**
 * Class DCTC_AI_Vector_DB_Factory
 */
class DCTC_AI_Vector_DB_Factory
{
	 ...
	 * @return DCTC_AI_Vector_DB_Base|WP_Error
	 */
	public static function create($provider, $config = [])
	{
		...
		switch ($provider) {
			...
			case 'sqlite':
				...
				require_once
					DCTC_PLUGIN_DIR . 'includes/ai/class-dctc-ai-vector-db-sqlite.php';

				$instance =
					new DCTC_AI_Vector_DB_SQLite(
						$config
					);
			...
			case 'pinecone':
				...
				require_once
					DCTC_PLUGIN_DIR . 'includes/ai/class-dctc-ai-vector-db-pinecone.php';
