<?php
/**
 * DCTC AI Vector DB - SQLite Adapter
 *
...
/**
 * Class DCTC_AI_Vector_DB_SQLite
 */
class DCTC_AI_Vector_DB_SQLite extends DCTC_AI_Vector_DB_Base {
	...
	public function store_embedding( $chunk_id, $embedding, $document_id = '' ) {
		...
		$embeddings_table = esc_sql( $wpdb->prefix . 'dctc_ai_embeddings' );
	...
	public function test_connection() {
		global $wpdb;
		$table_name = esc_sql( $wpdb->prefix . 'dctc_ai_embeddings' );
