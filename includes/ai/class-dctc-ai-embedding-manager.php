...
/**
 * Class DCTC_AI_Embedding_Manager
 */
class DCTC_AI_Embedding_Manager {
	...
	private function embed_openai( $text ) {
		$api_key = DCTC_AI_Settings_Handler::dctc_ai_get_provider_key( 'openai' );
	...
	private function embed_google( $text ) {
		$api_key = DCTC_AI_Settings_Handler::dctc_ai_get_provider_key( 'google' );
