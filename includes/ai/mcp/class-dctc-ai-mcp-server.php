...
class DCTC_AI_MCP_Server {
	 ...
	 * @var string
	 */
	private $cache_group = 'dctc_ai_mcp';
	...
	public function get_site_context() {
		$cache_key = 'dctc_ai_site_context';
		...
		$site_analyzer = DCTC_AI_Site_Analyzer::get_instance();
